...
public class UserResource {
	...
	@GetMapping(value = "/{id}") //método 'Get'Mapping recupera algo do banco de dados nesse caso
								 // ao usar /users/1(id) vai trazer esse método. Se for /users trará o método de cima
